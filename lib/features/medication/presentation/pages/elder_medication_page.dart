...
import '../widgets/stop_medication_button.dart';
import '../widgets/medication_history_section.dart';

class ElderMedicationPage extends ConsumerWidget {
  const ElderMedicationPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final elderId = ref.watch(authRepositoryProvider).currentUserId;
    ...
    return RefreshIndicator(
      ...
      child: ListView(
        ...
        children: [
          ...
          if (elderId != null) MedicationHistorySection(elderId: elderId!),
        ],
      ),
    );
  }
    ...
    try {
      await ref
          ...
          .confirmTaken(
            ...
            medicationName: widget.dose.schedule.medicationName,
            dosage: widget.dose.schedule.dosage,
  ...
  Widget build(BuildContext context) {
    ...
    final missed =
        ...
        DateTime.now().isAfter(
          widget.dose.scheduledAt.add(const Duration(hours: 5)),
        );
    return Card(
      child: Padding(
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  StopMedicationButton(schedule: schedule),
                ],
              ),
            ),
          ],
