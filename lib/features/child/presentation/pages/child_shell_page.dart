...
import '../../../account_linking/presentation/pages/child_links_page.dart';
...
class ChildShellPage extends ConsumerStatefulWidget {
  const ChildShellPage({super.key, required this.user});
  final AppUser user;
...
class _ChildShellPageState extends ConsumerState<ChildShellPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final hasActiveSos = sosAlerts?.asData?.value.isNotEmpty == true;
    ...
    final shell = Scaffold(
      ...
      body: IndexedStack(
        ...
        children: [
          ...
          ChildLinksPage(user: widget.user),
