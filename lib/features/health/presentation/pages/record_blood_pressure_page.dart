...
class RecordBloodPressurePage extends ConsumerStatefulWidget {
  const RecordBloodPressurePage({super.key});

  @override
  ConsumerState<RecordBloodPressurePage> createState() =>
      _RecordBloodPressurePageState();
}

class _RecordBloodPressurePageState
    extends ConsumerState<RecordBloodPressurePage> {
  int systolic = 120;
  int diastolic = 80;
  bool loading = false;
