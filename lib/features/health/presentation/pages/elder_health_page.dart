...
import 'elder_record_blood_pressure_page.dart';

class ElderHealthPage extends ConsumerWidget {
  const ElderHealthPage({super.key});
              ...
              FilledButton.icon(
                onPressed: () => Navigator.push(
                  ...
                  MaterialPageRoute<void>(
                    builder: (_) => const ElderRecordBloodPressurePage(),
                  ),
                ),
...
class _BloodPressureChartPainter extends CustomPainter {
  ...
  void _drawValueLabel(
    ...
    textPainter.paint(
      canvas,
      Offset(left + padding.left, top + padding.top),
    );
  }
